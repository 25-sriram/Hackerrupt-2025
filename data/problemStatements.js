...
Incidents related to harassment, stalking, and unsafe travel routes highlight the need for proactive and intelligent safety solutions. Traditional systems such as helpline numbers or mobile apps are reactive and depend on user visibility and network availability. Advances in AI, IoT, and location intelligence present an opportunity to build preventive, context-aware safety tools.`,
  ...
  {
    id: "HK2619",
    title: "Student Innovation – Hardware Track",
    description: `Problem Statement
This category encourages students to design and build physical systems, devices, or embedded solutions that solve real-world problems. Solutions may involve electronics, sensors, mechanical components, robotics, IoT, or smart devices.
Focus Areas Include:
...
Energy-efficient and sustainable hardware solutions`,
    expectedSolution: [
      "Working prototype or hardware model",
"Circuit design / block diagram",
"Sensor or device integration",
"Demonstration of real-world applicability",
    ],
    domains: "Embedded Systems, Internet of Things (IoT), Hardware Innovation",
  },

  {
    id: "HK2620",
    title: "Student Innovation – Software Track",
    description: `Problem Statement
This category focuses on software-driven solutions that use computing, data, or AI to address practical challenges. Projects may include web apps, mobile apps, AI/ML systems, simulations, or digital platforms.
...
"Functional application or platform",
"Algorithm or model design",
"User interface and experience design",
"Demonstration with real-world use case",
    ],
    domains: "Software Engineering, Artificial Intelligence, Digital Innovation",
  },
