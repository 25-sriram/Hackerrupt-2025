...
const Mascot = () => (
  <div className="relative w-100 h-100 animate-bob flex items-center justify-center">
    <img 
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="animate-slide-in-right">
          <div className="relative w-64 h-64 mx-auto rounded-full overflow-hidden border-2 border-green-400/50 shadow-lg">
            <video
              src="/robot.mp4"   // place robot.mp4 in /public folder
              autoPlay
              loop
              muted
              playsInline
